...
class EnumOperationCode(Enum):
    ...
    # --------------------- Paint ---------------------
    OP_1080001 = '1080001'  # Paint - Create
    OP_1080002 = '1080002'  # Paint - Update
    OP_1080003 = '1080003'  # Paint - List
    OP_1080004 = '1080004'  # Paint - Delete
    OP_1080005 = '1080005'  # Paint - View
