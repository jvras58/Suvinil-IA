...
class PaintFactory(factory.Factory):
    ...
    surface_type = factory.Faker('random_element', elements=list(SurfaceType))
    environment = factory.Faker('random_element', elements=list(Environment))
    finish_type = factory.Faker('random_element', elements=list(FinishType))
    features = factory.Faker('sentence', nb_words=10)
    paint_line = factory.Faker('random_element', elements=list(PaintLine))
